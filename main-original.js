...
ipcMain.handle('verificar-login', async (event, data) => {
  const { username, password } = data;

  // Realize a lógica para verificar as credenciais de login (consulta ao banco de dados, etc.)
  // Neste exemplo, vamos assumir que o login é válido se o usuário for "admin" e a senha for "admin123"
  const loginValido = (username === "admin" && password === "admin123");
